...
| Antigravity v2 Agent Manager (standalone app) | Working - separate CDP port, project/conversation navigator, history/scheduled-task entry points, new conversation, chat switching, rich transcript blocks |
