...
for (const marker of [
  ...
  "provider_usage_threshold: { category: 'provider_usage_warning'",
...
for (const marker of [
  ...
  "togglePreference('provider_usage_warning')",
  ...
  "kind === 'goal_attention' || kind === 'provider_usage_threshold'",
...
const result = {
  ...
  categories: ['permission_required', 'turn_ready', 'goal_completed', 'goal_attention', 'provider_usage_warning', 'agent_error', 'session_offline', 'rate_limit_cleared'],
