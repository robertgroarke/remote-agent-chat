...
const stages = [
  ...
  ['relay Claude observed timestamp reconciliation', ['tools/relay-claude-observed-timestamp-reconciliation-e2e.js']],
  ...
  ['durable extension message timestamps', ['tools/claude-extension-timestamp-smoke.js']],
