...
assert.match(relay, /respondToErrorPrompt\(sessionId, promptId, actionId\)/);
...
assert.match(chat, /respondToErrorPrompt\(sessionId, promptId, actionId\)/);
...
assert.match(component, /onAction\(prompt\.prompt_id, actionId\)/);
